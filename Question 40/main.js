...
var Album1 = make_album("Juice WRLD", "All Girls Are The Same");
var Album2 = make_album("Travis Scott", "FIEN");
var Album3 = make_album("Krystal Castles", "Kerosene");
console.log(Album1);
console.log(Album2);
console.log(Album3);
...
var Album4 = make_album2("Juice WRLD", "All Girls Are The Same", 20);
var Album5 = make_album2("Travis Scott", "FIEN");
var Album6 = make_album2("Krystal Castles", "Kerosene", 35);
console.log(Album4);
console.log(Album5);
console.log(Album6);
